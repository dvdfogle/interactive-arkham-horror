...
def getItemList(soup, base_url):
	start = soup.find(id="List_of_Reckonings").parent
...
page = requests.get(base_url + "/Reckoning")
...
with open("reckoning.json", "w", encoding="utf8") as outfile:
